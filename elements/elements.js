...
function loadShader(fileName) {
    var fileItem = document.createElement("script");
...
var TrackBall = (function (_super) {
    ...
    TrackBall.prototype.ready = function () {
        this._initRenderer();
        this._bindProjector();
        this._render();
    };
    ...
    //     this._render();
    // }
    TrackBall.prototype._initRenderer = function () {
        var width = 300;
        var height = 300;
        ...
        var camPos = new THREE.Vector3(0, 2, 0);
    ...
    TrackBall.prototype._bindProjector = function () {
        var _this = this;
        this.raycaster = new THREE.Raycaster();
        var _x = this;
        var canvas = this;
        canvas.onmousedown = function (e) { _x.isClick = true; };
        canvas.onmouseup = function (e) { _x.isClick = false; };
        canvas.onmousemove = function (event) {
            ...
            var intersects = _x.raycaster.intersectObjects(_x.scene.children);
            if (intersects.length > 0) {
                ...
                _this.fire("light-pos-changed", p.clone());
            }
        };
    };
    TrackBall.prototype._setupScene = function (scene) {
    ...
    TrackBall.prototype._render = function () {
...
TrackBall.register();
//# sourceMappingURL=track-ball.js.map
/// <reference path="../typings/threejs/three.d.ts" />
var pgLib = {}; // Global variable to keep all shader templates.
function loadShader(fileName) {
    var fileItem = document.createElement("script");
...
var BrdfViewport = (function (_super) {
    __extends(BrdfViewport, _super);
    function BrdfViewport() {
        _super.call(this);
        this.visible = false;
        this.visible = true;
        this.plotObjs = {};
    ...
    BrdfViewport.prototype.attached = function () {
        this.async(this._resize, 1);
        // this.async(this.notifyResize, 1);
        // this.renderJob();
    };
    BrdfViewport.prototype.attributeChanged = function (name, type) {
        // TODO: only target for item-selected?
        this._resize();
    };
    BrdfViewport.prototype._initRenderer = function () {
        var width = 300;
        var height = 300;
        this.renderer = new THREE.WebGLRenderer({ alpha: true });
        this.renderer.setSize(width, height);
    ...
    BrdfViewport.prototype._setupScene = function (scene) {
        var circleGeometry = new THREE.CircleGeometry(5, 32);
        var solidMaterial = new THREE.MeshBasicMaterial({ color: 0x777700, side: THREE.DoubleSide });
        var circle = new THREE.Mesh(circleGeometry, solidMaterial);
        ...
        bases.forEach(function (element, index, array) {
            var axis = new THREE.ArrowHelper(element.v, origin, 10.0, element.color, 1.0, 0.5);
            scene.add(axis);
        });
    ...
    BrdfViewport.prototype.updateShaderParam = function (shaderProp) {
        ...
        if (shaderName !== "all") {
            ...
            for (var key in this.plotObjs) {
                var material = this.plotObjs[key].material;
                material.uniforms[shaderProp.name].value = shaderProp.value;
            }
        }
        this.renderJob();
    ...
    BrdfViewport.prototype._render = function () {
        if (!this.visible) {
            return;
        }
    ...
    BrdfViewport.prototype._resize = function () {
    ...
    ], BrdfViewport.prototype, "scene", void 0);
    __decorate([
        property({ observer: "renderJob" })
    ], BrdfViewport.prototype, "visible", void 0);
    __decorate([
        listen("iron-resize")
    ], BrdfViewport.prototype, "_resize", null);
    BrdfViewport = __decorate([
        /// <reference path="../bower_components/polymer-ts/polymer-ts.d.ts" />
...
//# sourceMappingURL=brdf-viewport.js.map
/// <reference path="../bower_components/polymer-ts/polymer-ts.d.ts" />
/// <reference path="../typings/threejs/three.d.ts" />
/// <reference path="../typings/threejs/three-orbitcontrols.d.ts" />
...
var ModelViewport = (function (_super) {
    __extends(ModelViewport, _super);
    ...
    ModelViewport.prototype.ready = function () {
        this._initRenderer();
        this.scene = new THREE.Scene();
        this._setupScene(this.scene);
    };
    ModelViewport.prototype._initRenderer = function () {
        var width = 300;
        var height = 300;
        this.renderer = new THREE.WebGLRenderer({ alpha: true });
        this.renderer.setSize(width, height);
    ...
    ModelViewport.prototype._adjustCameraFocus = function (geometry) {
        geometry.center();
        var maxCorner = geometry.boundingBox.max;
        this.camera.position.copy(maxCorner.multiplyScalar(2.0));
    };
    ModelViewport.prototype.changeModel = function (modelName) {
        if (modelName === "sphere") {
            var oldMaterial = this.model.material;
            this.scene.remove(this.model);
            var sphere = new THREE.Mesh(new THREE.SphereGeometry(5, 64, 64, 0, Math.PI * 2, 0, Math.PI), oldMaterial);
            ...
            this.objLoader.load("assets/obj/" + modelName + ".obj", this._onModelLoaded.bind(this));
        }
    };
    ModelViewport.prototype._onModelLoaded = function (obj) {
        var oldMaterial = this.model.material;
        this.scene.remove(this.model);
    ...
    ModelViewport.prototype.renderJob = function () {
        this.debounce("model-viewport-render-job", function () {
            requestAnimationFrame(this._render.bind(this));
        }, 1);
    };
    ModelViewport.prototype._render = function () {
        if (!this.visible) {
            return;
        }
        this.cameraControl.update();
    ...
    ModelViewport.prototype._resize = function () {
        var width = this.clientWidth;
        var height = this.clientHeight;
        this.camera.aspect = width / height;
        this.camera.updateProjectionMatrix();
    ...
    __decorate([
        property({ observer: "renderJob" })
    ], ModelViewport.prototype, "visible", void 0);
    __decorate([
        listen("iron-resize")
    ], ModelViewport.prototype, "_resize", null);
    ModelViewport = __decorate([
        /// <reference path="../bower_components/polymer-ts/polymer-ts.d.ts" />
...
//# sourceMappingURL=model-viewport.js.map
Polymer({
            is: 'render-viewport',
